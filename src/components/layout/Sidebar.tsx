...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[var(--sidebar-width)] border-r border-[var(--border)] bg-[var(--surface)] flex flex-col z-40">
      {/* Logo */}
      <div className="h-[var(--header-height)] flex items-center px-5 border-b border-[var(--border)]">
        <Link href="/code-canvas" className="flex items-center gap-2.5 group">
